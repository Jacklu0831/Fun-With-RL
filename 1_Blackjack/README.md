...
My first dip into reinforcement learning is to calculate whether the AI player should draw a card in the game of blackjack under all combinations of states. This would be useful for Casinos.
...
The final policy generated by MC control. Gladly, it is identical to the optimal solution given [here](http://incompleteideas.net/book/bookdraft2017nov5.pdf)
